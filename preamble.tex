%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Main Sources
% 1: Andrew Tulloch (https://github.com/ajtulloch/CambridgeMathematicsPartIII/blob/master/common/common.tex)
% 2. https://github.com/trevorcampbell/tchdr/blob/master/tchdr.sty
% 3. https://gist.github.com/kristi/868327
% 4. https://gist.github.com/ZacCranko/ba90923045996eb6b0fb
% 5. Josh Davis: https://github.com/jdavis/latex-homework-template/blob/master/homework.tex
% Minor modifications made by: Shamindra Shrotriya
...
\usepackage[capitalize,sort]{cleveref} %nice reference package for automatically choosing names for references
...
\usepackage{listings} % for code blocks https://www.overleaf.com/help/71-how-do-i-include-sections-of-r-code-within-my-latex-document#.W57XMJNKjXE
...
\newcommand{\Ind}{\mathbb{I}}	% expectation
...
%%% Text              %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
% This is a nice way to add a separated text component in a line of proof
\newcommand{\qtext}[1]{\quad \left(\text{#1}\right)}
...
\newtheorem{nprob}{Problem}
\newtheorem{nsoln}{Solution}
...
% Shortcut to either bold or bar everything
\def\boldshortcuts{\def\boldorbar{\mathbf}}
\def\barshortcuts{\def\boldorbar{\bar}}
